...
class UpdateChecker(private val plugin: StatMasterX, private val config: FileConfiguration) {
    ...
    fun checkForUpdates() {
        ...
        try {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                if (latestVersion != null && isNewerVersion(latestVersion["name"] as String, plugin.description.version)) {
    ...
    private fun notifyUpdate(version: JSONObject) {
        ...
        notifyAdmins(component.toString())
    }
